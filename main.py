...
# Standardized Genkit Node.js Server URL
...
async def upload_receipt(
    ...
    return {"escrow_id": escrow_id, "ai_verdict": analysis, "current_status": escrow_manager.escrow_db[escrow_id]["status"]}

@app.post("/api/escrow/dispute/{escrow_id}")
async def raise_dispute(escrow_id: str, request: DisputeRequest) -> Dict[str, Any]:
    """Unified Dispute Mediator - Bridges to Genkit for Advanced Reasoning."""
    if escrow_id not in escrow_manager.escrow_db:
